...
public class DdsFileTypeSupport extends TypeSupportImpl {
	...
	private static final String TYPE_NAME = "DdsFile";

	private static final char[] PLUGIN_VERSION = { 2, 0, 0, 0 };
	private static final DdsFileTypeSupport _singleton = new DdsFileTypeSupport();
	 ...
	 * of RTI Connext.
	 */
	public static DdsFileTypeSupport get_instance() {
		return _singleton;
	}

	public static DdsFileTypeSupport getInstance() {
		return get_instance();
	}
	...
	public Object copy_data(Object destination, Object source) {
		...
		DdsFile typedSrc = (DdsFile) source;
	...
	public void deserialize_from_cdr_buffer(DdsFile dst, byte[] buffer, long length) {
		super.deserialize_from_cdr_buffer(dst, buffer, length);
	}

	public String data_to_string(DdsFile sample, PrintFormatProperty property) {
		return super.data_to_string(sample, property);
	}

	public String data_to_string(DdsFile sample) {
	...
	protected DataWriter create_datawriter(long native_writer, DataWriterListener listener, int mask) {
		return new DdsFileDataWriter(native_writer, listener, mask, this);
	}

	protected DataReader create_datareader(long native_reader, DataReaderListener listener, int mask) {

		return new DdsFileDataReader(native_reader, listener, mask, this);
	...
	protected DdsFileTypeSupport() {
		...
		super(TYPE_NAME, false, DdsFileTypeCode.VALUE, DdsFile.class, TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

	}

	protected DdsFileTypeSupport(boolean enableKeySupport) {

		super(TYPE_NAME, enableKeySupport, DdsFileTypeCode.VALUE, DdsFile.class, TypeSupportType.TST_STRUCT,
				PLUGIN_VERSION);
	}
}
