...
public class FileChunkTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "FileChunkType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FileChunkTypeTypeSupport _singleton
    = new FileChunkTypeTypeSupport();
    ...
    */
    public static FileChunkTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static FileChunkTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FileChunkTypeTypeCode.VALUE;
    }

    public Object create_data() {
        return FileChunkType.create();
    }
    ...
    * <code>this</code> is not a <code>FileChunkType</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FileChunkType typedDst = (FileChunkType) destination;
        FileChunkType typedSrc = (FileChunkType) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, 63308);
        if (include_encapsulation) {
        ...
        Object sample) 
    {
        ...
        FileChunkType typedSrc = (FileChunkType) sample;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.filename );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.filename,1024);

            dst.writeByteSeq(typedSrc.data,63308);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FileChunkType typedDst = (FileChunkType) dst;
            typedDst.clear();      
            try{
                typedDst.filename = src.readString(1024);
                src.readByteSequence(typedDst.data, 63308);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FileChunkType typedDst = (FileChunkType) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        FileChunkType typedDst
        = (FileChunkType) instance;
        FileChunkType typedSrc
        = (FileChunkType) key;
    ...
    */
    ...
    int mask) {
        return new FileChunkTypeDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FileChunkTypeDataReader(native_reader, listener, mask, this);   
    ...
    protected FileChunkTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,FileChunkTypeTypeCode.VALUE,FileChunkType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FileChunkTypeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FileChunkTypeTypeCode.VALUE,FileChunkType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
