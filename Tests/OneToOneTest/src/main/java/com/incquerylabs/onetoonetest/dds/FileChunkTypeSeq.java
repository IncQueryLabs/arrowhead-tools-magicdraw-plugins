...
/**
* A sequence of FileChunkType instances.
*/
@SuppressWarnings({ "serial", "unused" })
public final class FileChunkTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FileChunkTypeSeq() {
        super(FileChunkType.class);
    }

    public FileChunkTypeSeq (int initialMaximum) {
        super(FileChunkType.class, initialMaximum);
    }

    @SuppressWarnings("rawtypes")
	public FileChunkTypeSeq (Collection elements) {
        super(FileChunkType.class, elements);
    }

    public  FileChunkType get(int index) { 
        return (FileChunkType) super.get(index); 
    }
